	...
	<div class="row">
		...
		<?php //TODO have these lines optional / editable in Theme Options page ?>
            ...
            <p class="contact-social-network">
                <span><a href="https://www.facebook.com/satyadarshin.is.interested.in"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/facebook-logo_aluminium.png" title="" alt="Facebook icon"></a></span>
